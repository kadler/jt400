...
implements DBData
{
    ...
    **/
    ...
    {
        //3 possibilities:
        //1 Array = ï¿½9911'x ,  data type 2 bytes, data length 4 bytes, # of data items 4 bytes
        //2 Null Array = ï¿½9911'x , FFFF  (9911 + indicator)
        //3 NonArray = ï¿½9912'x ,  data type 2 bytes, data length 4 bytes
